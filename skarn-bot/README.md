...
Expected: `user_version 1`, `baseline OK`, `dup rejected: true`, `trade done: true 0 2`, `condense long uses gate output: true`, `condense short unchanged: true`, `condense tool unchanged: true`.
