...
**Goal:** Analyze GSC exports from `data/` → update `docs/reports/2026-08-20/unknown/SEO_PERFORMANCE.md`
...
Write `docs/reports/2026-08-20/unknown/SEO_PERFORMANCE.md` with sections in this order:
