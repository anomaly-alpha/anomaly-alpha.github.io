...
- Produces: updated `docs/reports/2026-08-20/unknown/SEO_PERFORMANCE.md`
...
Run: `node scripts/analyze-gsc.js`
Expected: "Report written: docs/reports/2026-08-20/unknown/SEO_PERFORMANCE.md" — open the file and verify all 9+ sections are present.

- [ ] **Step 4: Commit**

```bash
git add scripts/analyze-gsc.js docs/reports/2026-08-20/unknown/SEO_PERFORMANCE.md
...
```bash
git add scripts/analyze-gsc.js seo/index.html data/generated/seo-data.js docs/reports/2026-08-20/unknown/SEO_PERFORMANCE.md package.json
