...
22. `commands/preferences.js` — Rename proactive_opt_out → proactive_opt_in
23. `commands/level.js` — Use user_levels table (was levels.json)
24. `commands/leaderboard.js` — Use user_levels table
25. `commands/setlevelrole.js` — Use guild_config table (was config.json)
26. `commands/levelroles.js` — Use guild_config table
27. `commands/addfriend.js`, `removefriend.js` — Use friends table (was friends.json)
28. `bot.js` — Consolidate cron jobs, loadJSON→SQLite, fix silent errors
