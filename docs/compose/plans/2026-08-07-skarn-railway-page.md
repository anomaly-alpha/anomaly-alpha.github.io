...
- **Never `git add -A` / `git add .`.** Stage only the exact files listed in each task's Commit step. The working tree contains UNRELATED USER WIP (`docs/compose/spec/image-metadata.md`, `docs/reports/SEO_PERFORMANCE.md`, `skarn-bot/docs/plans/2026-08-05/...`, `skarn-bot/docs/specs/2026-08-05/...`, `skarn-bot/features/scheduler/index.js`, untracked `data/https___anomaly-alpha.github.io_-Image Metadata-2026-08-07/`) — never commit any of it.
...
- Spec: `docs/compose/specs/2026-08-07-skarn-railway-page-design.md` (committed). Blob URLs use branch `main`.
