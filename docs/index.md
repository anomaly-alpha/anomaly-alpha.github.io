...
| Promo Codes | Variable | 28 active codes (gems + tickets) |
...
- `/guide/code/` — Promo code guide: 28 active codes with click-to-copy (`copyCode()`), verification code redemption, 5 tips
