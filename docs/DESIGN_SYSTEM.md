...
```
anomaly-alpha/
├── styles.css       (1307 lines) — Design tokens + BEM classes + animations
├── index.html       (874 lines)  — HTML with inline JSON configs
├── script.js        (1399 lines) — JavaScript with token-aware logic
└── docs/
