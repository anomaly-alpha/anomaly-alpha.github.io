...
| Code | Variable | 24 active codes with gems + tickets |
...
- **Promo code reveal** — tap to reveal 24 active codes in a grid, tap any code to copy; redeem via verification code at redeem.invincible.ubisoft.barcelona
